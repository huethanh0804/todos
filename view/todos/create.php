...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Create new task</h1>
    <div class="">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="<?= href('todos', 'insert') ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title" id="" aria-describedby="helpId" placeholder="" value="">
